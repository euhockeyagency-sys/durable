...
const GUIDES = [
  ...
  { en: "hockey-agent-in-czechia", ru: "hokkejnyj-agent-v-chexii", cat: "process", title: { en: "Hockey agent in Czechia", ru: "Хоккейный агент в Чехии" } },
  { en: "hockey-agent-in-switzerland", ru: "hokkejnyj-agent-v-shvejcarii", cat: "process", title: { en: "Hockey agent in Switzerland", ru: "Хоккейный агент в Швейцарии" } },
  { en: "hockey-agent-in-austria", ru: "hokkejnyj-agent-v-avstrii", cat: "process", title: { en: "Hockey agent in Austria", ru: "Хоккейный агент в Австрии" } },
  { en: "hockey-agent-in-france", ru: "hokkejnyj-agent-vo-francii", cat: "process", title: { en: "Hockey agent in France", ru: "Хоккейный агент во Франции" } },
  { en: "hockey-agent-in-norway", ru: "hokkejnyj-agent-v-norvegii", cat: "process", title: { en: "Hockey agent in Norway", ru: "Хоккейный агент в Норвегии" } },
  { en: "hockey-agent-in-denmark", ru: "hokkejnyj-agent-v-danii", cat: "process", title: { en: "Hockey agent in Denmark", ru: "Хоккейный агент в Дании" } },
  { en: "hockey-agent-in-netherlands", ru: "hokkejnyj-agent-v-niderlandah", cat: "process", title: { en: "Hockey agent in the Netherlands", ru: "Хоккейный агент в Нидерландах" } },
  { en: "hockey-agent-in-slovakia", ru: "hokkejnyj-agent-v-slovakii", cat: "process", title: { en: "Hockey agent in Slovakia", ru: "Хоккейный агент в Словакии" } },
