...
const ARTICLES = [
  ...
  { slug: "hockey-agent-in-czechia", category: "Career", title: "Hockey agent in Czechia", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-chexii", category: "Карьера", title: "Хоккейный агент в Чехии" },
  { slug: "hockey-agent-in-switzerland", category: "Career", title: "Hockey agent in Switzerland", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-shvejcarii", category: "Карьера", title: "Хоккейный агент в Швейцарии" },
  { slug: "hockey-agent-in-austria", category: "Career", title: "Hockey agent in Austria", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-avstrii", category: "Карьера", title: "Хоккейный агент в Австрии" },
  { slug: "hockey-agent-in-france", category: "Career", title: "Hockey agent in France", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-vo-francii", category: "Карьера", title: "Хоккейный агент во Франции" },
  { slug: "hockey-agent-in-norway", category: "Career", title: "Hockey agent in Norway", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-norvegii", category: "Карьера", title: "Хоккейный агент в Норвегии" },
  { slug: "hockey-agent-in-denmark", category: "Career", title: "Hockey agent in Denmark", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-danii", category: "Карьера", title: "Хоккейный агент в Дании" },
  { slug: "hockey-agent-in-netherlands", category: "Career", title: "Hockey agent in the Netherlands", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-niderlandah", category: "Карьера", title: "Хоккейный агент в Нидерландах" },
  { slug: "hockey-agent-in-slovakia", category: "Career", title: "Hockey agent in Slovakia", domain: "eurohockeyagency.com" },
  { slug: "hokkejnyj-agent-v-slovakii", category: "Карьера", title: "Хоккейный агент в Словакии" },
  ...
  { slug: "what-to-ask-a-hockey-agent-before-a-trial", category: "For clubs", title: "What to ask a hockey agent before a trial", domain: "eurohockeyagency.com" },
  { slug: "running-an-efficient-trial-checklist", category: "For clubs", title: "Running an efficient trial: a checklist", domain: "eurohockeyagency.com" },
  { slug: "what-game-video-tells-a-club", category: "For clubs", title: "What game video tells a club", domain: "eurohockeyagency.com" },
